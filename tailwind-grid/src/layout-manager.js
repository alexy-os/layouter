export class LayoutManager {
      ...
      blank: {
        ...
        structure: {
          container: {
            ...
            content: {
              grid: {
                className: 'grid grid-cols-1 gap-8 h-96',
              }
            }
          }
        }
      ...
      hero: {
        ...
        structure: {
          container: {
            ...
            content: {
              grid: {
                className: 'grid grid-cols-2 gap-8 h-96',
                columns: [
                  {
      ...
      features: {
        ...
        structure: {
          container: {
            ...
            content: {
              grid: {
                className: 'grid grid-cols-3 gap-8 h-96',
                columns: [
  ...
  createSection(templateName = 'blank') {
    ...
    section.classList.add('layer', 'section-layer', 'w-full');
